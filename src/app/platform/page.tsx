...
export const metadata = {
  ...
  description: "Bekijk hoe Vynta bedrijfsprofielen, zakelijke vragen en directe gesprekken samenbrengt.",
};
    ...
    <MarketingShell>
      <section className="relative overflow-hidden border-b border-[#e4e7ea] bg-white">
        ...
        <div className="relative mx-auto grid max-w-[1180px] gap-12 px-5 py-20 sm:px-7 sm:py-28 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <Reveal>
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#e25231]">Zakelijk netwerkplatform</p>
            ...
            <p className="mt-6 max-w-xl text-[18px] leading-8 text-[#626872]">
              Vynta brengt samen wat je normaal over verschillende kanalen verspreidt: bedrijven ontdekken, hun context beoordelen, inhoudelijk reageren en contact houden.
            </p>
            <Link href="/onboarding" className="mt-8 inline-flex h-12 items-center gap-2 rounded-lg bg-[#17191c] px-5 text-sm font-bold text-white transition-all hover:-translate-y-1 hover:shadow-xl">
              Bedrijf aanmelden <ArrowRight size={17} />
            </Link>
          </Reveal>
      ...
      <section className="relative overflow-hidden bg-[#17191c] px-5 py-20 text-white sm:px-7 sm:py-24">
        ...
        <div className="relative mx-auto max-w-[1180px]">
          <Reveal className="grid gap-7 border-b border-white/10 pb-10 md:grid-cols-[1fr_0.7fr] md:items-end">
            <div><p className="text-xs font-bold uppercase tracking-[0.18em] text-[#ff8b6f]">Direct bruikbaar</p><h2 className="mt-4 max-w-3xl text-[36px] font-bold leading-tight tracking-[-0.045em] sm:text-[48px]">Alles wat nodig is om van signaal naar gesprek te gaan.</h2></div>
            <p className="text-[15px] leading-7 text-[#aeb4bd]">Een herkenbaar profiel, relevante bedrijven en zakelijke gesprekken komen samen in één duidelijke werkwijze.</p>
          </Reveal>
          <div className="grid gap-px overflow-hidden rounded-2xl border border-white/10 bg-white/10 mt-10 md:grid-cols-3">
            {[
              [Building2, "Bedrijfsprofiel", "Leg helder vast wie je bent, wat je doet en met wie je wilt verbinden."],
