...
import { ArrowRight, Bell, Building2, MessageSquare, Search, Target, Users } from "lucide-react";
...
export const metadata = {
  ...
  description: "Bekijk hoe Vynta zakelijke vragen, bedrijfsprofielen en directe gesprekken samenbrengt.",
};
    ...
    <MarketingShell>
      <section className="relative overflow-hidden border-b border-[#e4e7ea] bg-white">
        ...
        <div className="relative mx-auto grid max-w-[1180px] gap-12 px-5 py-20 sm:px-7 sm:py-28 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <Reveal>
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#e25231]">Het platform</p>
            ...
            <p className="mt-6 max-w-xl text-[18px] leading-8 text-[#626872]">
              Vynta brengt de onderdelen die je normaal over verschillende kanalen verspreidt samen: ontdekken, beoordelen, reageren en contact houden.
            </p>
            <Link href="/onboarding" className="mt-8 inline-flex h-12 items-center gap-2 rounded-lg bg-[#17191c] px-5 text-sm font-bold text-white transition-all hover:-translate-y-1 hover:shadow-xl">
              Start met je bedrijf <ArrowRight size={17} />
            </Link>
          </Reveal>
